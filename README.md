...
* Support for writing test code in any programming language. See [Test Code](http://getgauge.io/documentation/test_code/README.html) for currently supported languages.
* A modular architecture with [plugin](http://getgauge.io/documentation/plugins/README.html) support.
...
*	Extensible through [Plugins](http://getgauge.io/documentation/plugins/README.html) and Hackable
...
* [Create a gauge project](http://getgauge.io/documentation/getting_started/creating_a_gauge_project.html)
* [Execute Specifications](http://getgauge.io/documentation/execution/README.html)
