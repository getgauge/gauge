...
const (
	...
	Message_FileEditResponse               Message_MessageType = 30
)
...
func (Message_MessageType) EnumDescriptor() ([]byte, []int) { return fileDescriptor1, []int{38, 0} }
...
type FileEditParam struct {
	// / Line number where the change needs to be made
	LineNumber int32 `protobuf:"varint,1,opt,name=lineNumber" json:"lineNumber,omitempty"`
	// / Content which will be added
	Content string `protobuf:"bytes,2,opt,name=content" json:"content,omitempty"`
}

func (m *FileEditParam) Reset()                    { *m = FileEditParam{} }
func (m *FileEditParam) String() string            { return proto.CompactTextString(m) }
func (*FileEditParam) ProtoMessage()               {}
func (*FileEditParam) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{36} }

func (m *FileEditParam) GetLineNumber() int32 {
	if m != nil {
		return m.LineNumber
	}
	return 0
...
func (m *FileEditParam) GetContent() string {
	if m != nil {
		return m.Content
	}
	return ""
...
// / Response having a list of file edits along with the filePath
type FileEditResponse struct {
	// / File Path of the file to be edited
	FilePath string `protobuf:"bytes,1,opt,name=filePath" json:"filePath,omitempty"`
	// / list of edits to the file
	FileEdits []*FileEditParam `protobuf:"bytes,2,rep,name=fileEdits" json:"fileEdits,omitempty"`
}

func (m *FileEditResponse) Reset()                    { *m = FileEditResponse{} }
func (m *FileEditResponse) String() string            { return proto.CompactTextString(m) }
func (*FileEditResponse) ProtoMessage()               {}
func (*FileEditResponse) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{37} }

func (m *FileEditResponse) GetFilePath() string {
	if m != nil {
		return m.FilePath
	}
	return ""
...
func (m *FileEditResponse) GetFileEdits() []*FileEditParam {
	if m != nil {
		return m.FileEdits
	}
	return nil
...
type Message struct {
	...
	// / [FileEditResponse](#gauge.messages.FileEditResponse)
	FileEditResponse *FileEditResponse `protobuf:"bytes,33,opt,name=fileEditResponse" json:"fileEditResponse,omitempty"`
}

func (m *Message) Reset()                    { *m = Message{} }
func (m *Message) String() string            { return proto.CompactTextString(m) }
func (*Message) ProtoMessage()               {}
func (*Message) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{38} }
...
func (m *Message) GetFileEditResponse() *FileEditResponse {
	if m != nil {
		return m.FileEditResponse
	}
	return nil
}
...
func init() {
	...
	proto.RegisterType((*FileEditParam)(nil), "gauge.messages.FileEditParam")
	proto.RegisterType((*FileEditResponse)(nil), "gauge.messages.FileEditResponse")
...
var fileDescriptor1 = []byte{
	...
	,
}
