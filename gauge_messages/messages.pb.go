...
type StubImplementationCodeRequest struct {
	...
	Steps []*StepValidateRequest `protobuf:"bytes,2,rep,name=steps" json:"steps,omitempty"`
}
...
func (m *StubImplementationCodeRequest) GetSteps() []*StepValidateRequest {
	if m != nil {
		return m.Steps
	}
	return nil
...
var fileDescriptor1 = []byte{
	...
	,
}
