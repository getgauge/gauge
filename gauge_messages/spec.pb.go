...
type ProtoSuiteResult struct {
	...
	// / Additional information at exec time to be available on reports
	Message []string `protobuf:"bytes,13,rep,name=message" json:"message,omitempty"`
}
...
func (m *ProtoSuiteResult) GetMessage() []string {
	if m != nil {
		return m.Message
	}
	return nil
...
var fileDescriptor2 = []byte{
	...
	,
}
