...
type Message struct {
	MessageType *Message_MessageType `protobuf:"varint,1,req,name=messageType,enum=messages.Message_MessageType" json:"messageType,omitempty"`
...
func init() {
	proto.RegisterEnum("messages.Message_MessageType", Message_MessageType_name, Message_MessageType_value)
}
