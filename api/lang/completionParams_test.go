...
var testParamEditPosition = []struct {
...
}{
	{
		...
		wantRange: lsp.Range{Start: lsp.Position{Line: 0, Character: 13}, End: lsp.Position{Line: 0, Character: 19}},
	},
	{
	...
	},
	{
		...
		wantRange: lsp.Range{Start: lsp.Position{Line: 0, Character: 33}, End: lsp.Position{Line: 0, Character: 39}},
	},
	{
		input:     `* Step with "static" param and <dynamic> param`,
		cursorPos: lsp.Position{Line: 0, Character: 35},
		wantRange: lsp.Range{Start: lsp.Position{Line: 0, Character: 32}, End: lsp.Position{Line: 0, Character: 39}},
	},
	{
		input:     `* Step with "static" param and <dynamic> param`,
		cursorPos: lsp.Position{Line: 0, Character: 13},
...
func TestGetParamEditPosition(t *testing.T) {
	for _, test := range testParamEditPosition {
		...
		gotRange := getParamEditRange(test.input, pline, test.cursorPos)
